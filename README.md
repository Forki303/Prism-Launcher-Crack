...
#DOES NOT WORK ON VERSIONS ABOVE 9.4. CLIENT VERIFICATION HAS BEEN ADDED TO PRISM LAUNCHER.

A simple script to crack Prism Launcher.
Usage: Download the [latest](https://prismlauncher.org/) version of Prism Launcher, open it, and then close it. Run the appropriate script as administrator (Russian or English version). If an error occurs, try restarting Prism Launcher or downloading an older version [(9.4)](https://github.com/PrismLauncher/PrismLauncher/releases/tag/9.4).
If something doesn't work, create a new discussion and I'll try to help you.

#НЕ РАБОТАЕТ НА ВЕРСИЯХ ВЫШЕ 9.4, ПРИСМ ЛАУНЧЕР ДОБАВИЛИ ВЕРИФИКАЦИЮ КЛИЕНТА
