...
v1.0 Usage: Download Prism Launcher [9.4](https://github.com/PrismLauncher/PrismLauncher/releases/tag/9.4), open it, and then close it. Run the corresponding script as administrator (Russian or English version). <br />
<br />
